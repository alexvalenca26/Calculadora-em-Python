...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.ui.adicaoButton.clicked.connect(lambda:pressionado ("+"))
        ...
        self.ui.clearButtuon.clicked.connect(lambda:clearOutput())
        self.ui.backspaceButton.clicked.connect(lambda:backspace())
        self.ui.igualButton.clicked.connect(lambda:resultado())
        self.ui.porcentagemButton.clicked.connect(lambda:pressionado("%"))
